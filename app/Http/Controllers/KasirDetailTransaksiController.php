...
class KasirDetailTransaksiController extends Controller
{
    /**
    ...
    public function index(Transaksi $transaksi)
    {
        ...
        return view('kasir.detail-transaksi.index', [
    ...
    {
        return view('kasir.detail-transaksi.edit', [
    ...
    {        
        ...
        return redirect()->route('kasir.detail-transaksi.index', compact('transaksi', 'detailTransaksi'))->with('message','Data Transaksi ('. $transaksi->kode .') Berhasil di Update');
    }
