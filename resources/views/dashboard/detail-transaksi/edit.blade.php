<x-dashboard>
    <x-edit title="{{ $transaksi->kode }}" route="{{ route('detail-transaksi.update', compact('transaksi', 'detail_transaksi')) }}">

        {{-- Button --}}
        <x-slot:button>
            @livewire('delete-detail-transaksi', compact('transaksi', 'detail_transaksi'))
        </x-slot:button>
